...
namespace hopeuperman_adminPanel
{
    public class AdminDatasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdminId,AdminUsername,AdminPassword,AdminEmail,AddedDate")] AdminData adminData)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,AdminUsername,AdminPassword,AdminEmail,AddedDate")] AdminData adminData)
        {
