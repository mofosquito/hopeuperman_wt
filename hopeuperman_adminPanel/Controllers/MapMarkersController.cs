...
namespace hopeuperman_adminPanel.Controllers
{
    public class MapMarkersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MarkerId,Longitude,Latitude,LocationName,MainLangauge,Dialect,AudioFile,Translation,Tag,AdminId")] MapMarkers mapMarkers)
        {
            ...
            ViewData["AdminId"] = new SelectList(_context.AdminData, "AdminId", "AdminId", mapMarkers.AddedbyAdmin);
            return View(mapMarkers);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarkerId,Longitude,Latitude,LocationName,MainLangauge,Dialect,AudioFile,Translation,Tag,AdminId")] MapMarkers mapMarkers)
        {
